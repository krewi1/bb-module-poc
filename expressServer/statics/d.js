(function(undefined) {
    ...
    var DEBUG = false;
    var __component_index = __bbb.Kf;
    var __useState_index = __bbb.Lf;
    var __styledDiv_index = __bbb.Mf;
    var __export_default = __component_index(function CounterModule() {
        var _a = __useState_index(0), count = _a[0], setCounter = _a[1];
        return [ __styledDiv_index(count), {
            tag: "button",
            children: "+",
            onClick: function() {
                return setCounter(function(prevstate) {
                    return prevstate + 1;
                });
            }
        }, {
